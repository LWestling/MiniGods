...
public class TerrainColumn {
    ...
    private ArrayList<Integer> columnIndicies;

    public TerrainColumn(int height) {
    ...
    public ArrayList<Integer> getColumnIndicies() {
